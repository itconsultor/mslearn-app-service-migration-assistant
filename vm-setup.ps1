...
$wc.DownloadFile("https://appmigration.microsoft.com/api/download/windows/AppServiceMigrationAssistant.msi", "C:\Exercise\AppServiceMigrationAssistant.msi")
...
Start-Process "msiexec.exe" -ArgumentList '/I "C:\Exercise\AppServiceMigrationAssistant.msi" /qn /norestart ALLUSERS=1' -Wait -NoNewWindow
